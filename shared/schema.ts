...
export const members = pgTable("members", {
  ...
  primaryPackageId: integer("primary_package_id").references(() => packages.id),
...
export const packages = pgTable("packages", {
  ...
  billingCycle: text("billing_cycle", { enum: ["1_month", "3_months", "1_year"] }).default("1_month").notNull(),
  description: text("description"),
  price: numeric("price").notNull(),
  durationDays: integer("duration_days").notNull(),
  branchId: integer("branch_id").references(() => branches.id),
  gymAccessHours: integer("gym_access_hours"),
  coachHours: integer("coach_hours").default(0),
  dietitianHours: integer("dietitian_hours").default(0),
